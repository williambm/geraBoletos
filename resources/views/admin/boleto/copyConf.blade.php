...
@section('content')
    ...
    <span>Você está trabalhando no grupo <b>{{$grupo->nome}}</b></span>
    <hr>
    <form action="{{route('admin.boleto.store')}}" method="post">
        ...
        <div class="row">
            <div class="col-10">
                ...
                <input type="text" name="nomeEvento" id="nomeEvento" class="form-control mb-1  @error('nomeEvento') is-invalid @enderror" value="{{$boletoBase->nomeEvento}}">
        ...
        <div class="row">
            <div class="col-10">
                ...
                <textarea name="obsLegal" cols="30" rows="05" id="obsLegal" class="form-control mb-1 @error('obsLegal') is-invalid @enderror" value="{{$boletoBase->obsLegal}}">{{$boletoBase->obsLegal}}</textarea>
        ...
        <div class="row">
            <div class="col-10">
                ...
                <textarea type="text" cols="30" rows="05"name="infoSacado" id="infoSacado" class="form-control mb-1" value="{{$boletoBase->infoSacado}}">{{$boletoBase->infoSacado}}</textarea>
        ...
        <div class="row">
            <div class="col-7">
                ...
                <input type="text" name="instrObjCobranca" id="instrObjCobranca" class="form-control mb-1 @error('instrObjCobranca') is-invalid @enderror" value="{{$boletoBase->instrObjCobranca}}">
            ...
            <div class="col-3">
                ...
                <input type="number" name="limQtdeInscritos" id="limQtdeInscritos" class="form-control mb-1" value="{{$boletoBase->limQtdeInscritos}}">
            </div>
        </div>
        <div class="row mb-1 mt-1">
            <div class="col-5">
                <label >Estrutura Hierárquica <b style="color:red;">*</b></label>
                <input type="text" name="estrutHierarq" id="estrutHierarq" class="form-control mb-1 @error('estrutHierarq') is-invalid @enderror" value="{{$boletoBase->estrutHierarq}}">
            ...
            <div class="col-3">
                ...
                <input type="number" name="codFonteRecurso" id="codFonteRecurso" class="form-control mb-1 @error('codFonteRecurso') is-invalid @enderror" value="{{$boletoBase->codFonteRecurso}}">
            ...
            <div class="col-2">
                ...
                <input type="number" name="codUnidade" id="codUnidade" class="form-control mb-1 @error('codUnidade') is-invalid @enderror" value="{{$boletoBase->codUnidade}}"> 
        ...
        <div class="form-row">
            <div class="col-3">
                ...
                <input type="text" name="nomeFonte" id="nomeFonte" class="form-control @error('nomeFonte') is-invalid @enderror" value="{{$boletoBase->nomeFonte}}">
            ...
            <div class="col-4">
                ...
                <input type="text" name="nomeSubFonte" id="nomeSubFonte" class="form-control @error('nomeSubFonte') is-invalid @enderror" value="{{$boletoBase->nomeSubFonte}}">
            ...
            <div class="col-3">
                ...
                <input type="number" name="codConvenio" id="codConvenio" class="form-control mb-1" value="{{$boletoBase->codConvenio}}">
